...
public class SUBWOOFCommandSide extends SequentialCommandGroup {
    /** Creates a new SpeakerCommand. */
    public SUBWOOFCommandSide(Shooter shooter, Intake intake) {
        ...
        addCommands(
                ...
                new SequentialCommandGroup(
                        ...
                        shooter.setPivotAngleCommand(RobotConstants.SUBWOOF_ShooterPivotAngle-0.5),
