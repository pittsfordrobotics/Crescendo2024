...
public class RobotContainer {
  ...
  private void configure_COMP_Bindings() {
    ...
    // Command blueampheadingcommand =
    // swerveSubsystem.correctHeading(Rotation2d.fromDegrees(-90))
    // .beforeStarting(Commands.runOnce(() -> vision.useVision(false)));
    // Command redampheadingcommand =
    // swerveSubsystem.correctHeading(Rotation2d.fromDegrees(90))
    // .beforeStarting(Commands.runOnce(() -> vision.useVision(false)));
    ...
    m_driverController.b().onTrue(
        new ParallelCommandGroup(
            ...
            new ConditionalCommand(
                swerveSubsystem.headingDriveCommand(() -> -m_driverController.getLeftY(),
                    () -> -m_driverController.getLeftX(), () -> Rotation2d.fromDegrees(-90)),
                swerveSubsystem.headingDriveCommand(() -> -m_driverController.getLeftY(),
                    () -> -m_driverController.getLeftX(), () -> Rotation2d.fromDegrees(90)),
