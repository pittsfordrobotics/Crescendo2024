...
public class IntakeConstants {
    ...
    public static final double INTAKE_Pivot_P = 0.012;//.012
    public static final double INTAKE_Pivot_I = 0;
    public static final double INTAKE_Pivot_D = 0.025;//.025
    ...
    public static final double INTAKE_Pivot_FF_Multiplier = 0.028; //.35 for basic ff
